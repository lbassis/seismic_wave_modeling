	...
	{	for (by = 0; by < get_nby(); by++)
		{
			...
			if (node == rank)
			{
				...
				// CPMLS
				// arrays
				allocate_float_vector_on_node(&block->phiv_handle[0], &block->phivxx, block->nb_cpml);
				allocate_float_vector_on_node(&block->phiv_handle[1], &block->phivxy, block->nb_cpml);
				allocate_float_vector_on_node(&block->phiv_handle[2], &block->phivxz, block->nb_cpml);
				allocate_float_vector_on_node(&block->phiv_handle[3], &block->phivyx, block->nb_cpml);
				allocate_float_vector_on_node(&block->phiv_handle[4], &block->phivyy, block->nb_cpml);
				allocate_float_vector_on_node(&block->phiv_handle[5], &block->phivyz, block->nb_cpml);
				allocate_float_vector_on_node(&block->phiv_handle[6], &block->phivzx, block->nb_cpml);
				allocate_float_vector_on_node(&block->phiv_handle[7], &block->phivzy, block->nb_cpml);
				allocate_float_vector_on_node(&block->phiv_handle[8], &block->phivzz, block->nb_cpml);

				allocate_float_vector_on_node(&block->phit_handle[0], &block->phitxxx, block->nb_cpml);
				allocate_float_vector_on_node(&block->phit_handle[1], &block->phitxyy, block->nb_cpml);
				allocate_float_vector_on_node(&block->phit_handle[2], &block->phitxzz, block->nb_cpml);
				allocate_float_vector_on_node(&block->phit_handle[3], &block->phitxyx, block->nb_cpml);
				allocate_float_vector_on_node(&block->phit_handle[4], &block->phityyy, block->nb_cpml);
				allocate_float_vector_on_node(&block->phit_handle[5], &block->phityzz, block->nb_cpml);
				allocate_float_vector_on_node(&block->phit_handle[6], &block->phitxzx, block->nb_cpml);
				allocate_float_vector_on_node(&block->phit_handle[7], &block->phityzy, block->nb_cpml);
				allocate_float_vector_on_node(&block->phit_handle[8], &block->phitzzz, block->nb_cpml);
			...
			if (block->boundary_blocks[XP]) {
				...
				if (node == rank) {
					allocate_block_on_node(&block->v_boundaries_handle[XP][0], &block->v_boundaries[XP][0], 1, 1, 1);
					allocate_block_on_node(&block->v_boundaries_handle[XP][1], &block->v_boundaries[XP][1], 1, 1, 1);
					allocate_block_on_node(&block->v_boundaries_handle[XP][2], &block->v_boundaries[XP][2], 1, 1, 1);
					
					allocate_block_on_node(&block->t_boundaries_handle[XP][0], &block->t_boundaries[XP][0], 1, 1, 1);
					allocate_block_on_node(&block->t_boundaries_handle[XP][1], &block->t_boundaries[XP][1], 1, 1, 1);
					allocate_block_on_node(&block->t_boundaries_handle[XP][2], &block->t_boundaries[XP][2], 1, 1, 1);
					allocate_block_on_node(&block->t_boundaries_handle[XP][3], &block->t_boundaries[XP][3], 1, 1, 1);
					allocate_block_on_node(&block->t_boundaries_handle[XP][4], &block->t_boundaries[XP][4], 1, 1, 1);
					allocate_block_on_node(&block->t_boundaries_handle[XP][5], &block->t_boundaries[XP][5], 1, 1, 1);
				}
			}
			...
			if (block->boundary_blocks[XM]) {
				...
				if (node == rank) {/*on domain border, allocate with size=1 to avoid null pointers*/
					allocate_block_on_node(&block->v_boundaries_handle[XM][0], &block->v_boundaries[XM][0], 1, 1, 1);
					allocate_block_on_node(&block->v_boundaries_handle[XM][1], &block->v_boundaries[XM][1], 1, 1, 1);
					allocate_block_on_node(&block->v_boundaries_handle[XM][2], &block->v_boundaries[XM][2], 1, 1, 1);
					
					allocate_block_on_node(&block->t_boundaries_handle[XM][0], &block->t_boundaries[XM][0], 1, 1, 1);
					allocate_block_on_node(&block->t_boundaries_handle[XM][1], &block->t_boundaries[XM][1], 1, 1, 1);
					allocate_block_on_node(&block->t_boundaries_handle[XM][2], &block->t_boundaries[XM][2], 1, 1, 1);
					allocate_block_on_node(&block->t_boundaries_handle[XM][3], &block->t_boundaries[XM][3], 1, 1, 1);
					allocate_block_on_node(&block->t_boundaries_handle[XM][4], &block->t_boundaries[XM][4], 1, 1, 1);
					allocate_block_on_node(&block->t_boundaries_handle[XM][5], &block->t_boundaries[XM][5], 1, 1, 1);
				}
			}
			...
			if (block->boundary_blocks[YM]) {
				...
				if ((node == rank) || (ym_node == rank))
				{
					...
					printf("allocated %d Octets on boundary\n", block->pitchx*K*block->pitchz*4);
STOP
