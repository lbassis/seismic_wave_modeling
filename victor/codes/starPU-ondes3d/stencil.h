...
// Timing
//#define gettime(A) clock_gettime(CLOCK_MONOTONIC_RAW, &A)
#define gettime(A) clock_gettime(CLOCK_MONOTONIC, &A)
#define secdur(S,E) ((float)(E.tv_sec-S.tv_sec + (E.tv_nsec-S.tv_nsec)/1000000000.0f))
#define msecdur(S,E) ((float)((E.tv_sec-S.tv_sec)*1000.0f + (E.tv_nsec-S.tv_nsec)/1000000.0f))
...
extern float time_spent_idle[STARPU_NMAXWORKERS];
extern float time_spent_idle[STARPU_NMAXWORKERS];
extern struct timespec pu_last_use[STARPU_NMAXWORKERS];
