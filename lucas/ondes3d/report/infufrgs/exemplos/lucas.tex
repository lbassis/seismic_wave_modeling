...
% o artigo diz the experiments conducted registered a maximum speedup of 77× compared to the simulation time of the serial version
...
\todo{Substituir ``Dinâmica de fluídos'' pelo nome da aplicação. - aguardando resposta do nesi porque nao achei no artigo}
\begin{table}[htb!]
