...
\todo{Entendi que devido ao problema no DAG, abandonaste a ideia de
  usar as outras máquinas.}
...
\todo{Ao comparar os resultados numéricos! (ou seja a simulação física
em si)}
...
\todo{``nodos'' é uma palavra que inexiste em pt-br, usar nós.}
\todo{Explicar as setas como uma dependência de quem produz o dado
  para quem o consome.}
...
\todo{Achei que esse capítulo de resultados ficou demasiado
  pequeno. Talvez pudesse estendê-lo de alguma forma, mas sinceramente
  nesta altura (deadline amanhã) penso ser difícil. Uma possibilidade
  é tu tentar explicar exatamente onde está o erro, e descrevê-lo. Não
  sei bem como a banca vai receber e interpretar este tipo de
  resultado. Mas bom, é o que temos}
